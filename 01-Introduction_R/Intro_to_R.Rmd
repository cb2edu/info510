...
## Multiplots in ggplot

There are four ways to draw the multiplots in ggplot2:
...
g
```
To plot the previous plot, we need combine the entire dataframe into two variables.
